/**
 * Implementation of multi-stream HTTP transfers for the TPCRHandler
 */
...
int TPCRHandler::RunCurlWithStreamsImpl(XrdHttpExtReq &req, State &state,
...
int TPCRHandler::RunCurlWithStreams(XrdHttpExtReq &req, State &state,
